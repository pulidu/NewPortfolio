  ...
  return (
    <section className="min-h-screen bg-black text-white px-6 md:px-16 py-20">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div>
          {/* Badge */}
          <button className="border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 px-5 py-2 rounded-full text-sm tracking-wide mb-8">
            • ABOUT ME
          </button>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mb-12">
            ...
            {/* Card 1 */}
            <div className="bg-[#0b0b0b] border border-emerald-500/10 rounded-2xl p-5 hover:border-emerald-400/30 transition">
          ...
          <div className="flex flex-wrap items-center gap-6">
            <button className="bg-emerald-400 hover:bg-emerald-300 text-black font-semibold px-8 py-4 rounded-2xl flex items-center gap-3 transition">
              Let’s Build Something
              <ArrowRight size={20} />
            </button>

            <button className="flex items-center gap-3 text-white hover:text-emerald-400 transition">
              <Download size={20} />
              Download CV
            </button>
          </div>
        ...
        <div className="flex items-center justify-between gap-8 relative">
          ...
          <div className="flex-1 border border-emerald-500/20 rounded-[30px] p-6 bg-[#050505] relative overflow-hidden">
            ...
            {/* Glow */}
            <div className="absolute top-20 left-20 w-72 h-72 bg-emerald-400/30 blur-[120px] rounded-full"></div>

            {/* Dots */}
            <div className="absolute top-10 left-10 grid grid-cols-8 gap-3 opacity-30">
              {[...Array(40)].map((_, i) => (
                <span
                  key={i}
            ...
            {/* Bottom Card */}
            <div className="relative z-20 mt-6 border border-emerald-500/20 bg-black/60 backdrop-blur-md rounded-3xl p-5 flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <p className="text-gray-200 text-sm md:text-base leading-7">
                  ...
                  and creating solutions that truly help people.
                </p>
              </div>

              <div className="bg-emerald-400 w-14 h-14 rounded-2xl flex items-center justify-center">
          ...
          <div className="flex flex-col items-center gap-6 self-start pt-12">
            ...
            {/* Divider line */}
            <div className="w-[1px] h-12 bg-gray-800 mb-2"></div>

            {/* Behance */}
            <a href="#" className="w-12 h-12 rounded-full bg-[#1769ff] flex items-center justify-center font-bold text-sm text-white hover:scale-110 transition">
              Bē
            </a>
            ...
            {/* LinkedIn */}
            <a href="#" className="w-12 h-12 rounded-full bg-[#0077b5] flex items-center justify-center hover:scale-110 transition">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            {/* GitHub */}
            <a href="#" className="w-12 h-12 rounded-full bg-[#24292e] flex items-center justify-center hover:scale-110 transition">
              <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
