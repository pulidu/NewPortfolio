        ...
        >
          <div className="flex-1 w-full border border-[#00e5c0]/20 rounded-[24px] sm:rounded-[30px] p-4 sm:p-6 lg:p-8 bg-[#050505] relative overflow-hidden">
            ...
            <div className="absolute top-6 left-6 sm:top-10 sm:left-10 grid grid-cols-8 gap-2 sm:gap-3 opacity-20 pointer-events-none">
              {[...Array(40)].map((_, i) => (
                <span key={i} className="w-1 h-1 sm:w-1.5 sm:h-1.5 bg-emerald-400 rounded-full" />
              ))}
            </div>
            ...
            <motion.div
              className="relative z-20 mt-4 sm:mt-6 border border-[#00e5c0]/20 bg-black/70 backdrop-blur-md rounded-2xl sm:rounded-3xl p-4 flex items-center justify-between gap-3"
              initial={{ opacity: 0, y: 10 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
              transition={{ delay: 0.6, duration: 0.5 }}
            >
              <div className="flex items-center gap-3 sm:gap-4">
                <div className="bg-[#00e5c0]/10 w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0">
                  <Target className="text-[#00e5c0]" size={20} />
                </div>
                <p className="text-gray-200 text-xs sm:text-sm leading-relaxed">
                  Passionate about clean code, user experience, and smart solutions.
                </p>
              </div>
              <div className="bg-[#00e5c0] w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0 hidden sm:flex">
